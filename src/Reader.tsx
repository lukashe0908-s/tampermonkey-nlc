...
export default function Reader() {
  ...
  */}
      <head>
        ...
        <link rel='resource' type='application/l10n' href='https://pdf.misee.dns.army/web/locale/locale.json' />
        <link rel='stylesheet' href='https://pdf.misee.dns.army/web/viewer.css' />
      </head>
      <body style={isLoading ? { display: 'none' } : {}}>
          ...
          <div id='mainContainer'>
            <div className='findbar hidden doorHanger' id='findbar'>
              ...
              <div id='findbarOptionsOneContainer'>
                ...
                <label htmlFor='findHighlightAll' className='toolbarLabel' data-l10n-id='pdfjs-find-highlight-checkbox'>
                  Highlight All
                </label>
                <input type='checkbox' id='findMatchCase' className='toolbarField' tabIndex={95} />
                <label htmlFor='findMatchCase' className='toolbarLabel' data-l10n-id='pdfjs-find-match-case-checkbox-label'>
                  Match Case
                </label>
              </div>
              <div id='findbarOptionsTwoContainer'>
                <input type='checkbox' id='findMatchDiacritics' className='toolbarField' tabIndex={96} />
                <label htmlFor='findMatchDiacritics' className='toolbarLabel' data-l10n-id='pdfjs-find-match-diacritics-checkbox-label'>
                  Match Diacritics
                </label>
                <input type='checkbox' id='findEntireWord' className='toolbarField' tabIndex={97} />
                <label htmlFor='findEntireWord' className='toolbarLabel' data-l10n-id='pdfjs-find-entire-word-checkbox-label'>
                  Whole Words
                </label>
              </div>
            ...
            <div className='editorParamsToolbar hidden doorHangerRight' id='editorFreeTextParamsToolbar'>
              <div className='editorParamsToolbarContainer'>
                <div className='editorParamsSetter'>
                  <label htmlFor='editorFreeTextColor' className='editorParamsLabel' data-l10n-id='pdfjs-editor-free-text-color-input'>
                    Color
                  </label>
                  <input type='color' id='editorFreeTextColor' className='editorParamsColor' tabIndex={103} />
                </div>
                <div className='editorParamsSetter'>
                  <label htmlFor='editorFreeTextFontSize' className='editorParamsLabel' data-l10n-id='pdfjs-editor-free-text-size-input'>
                    Size
                  </label>
                  <input
                    type='range'
            ...
            <div className='editorParamsToolbar hidden doorHangerRight' id='editorInkParamsToolbar'>
              <div className='editorParamsToolbarContainer'>
                <div className='editorParamsSetter'>
                  <label htmlFor='editorInkColor' className='editorParamsLabel' data-l10n-id='pdfjs-editor-ink-color-input'>
                    Color
                  </label>
                  <input type='color' id='editorInkColor' className='editorParamsColor' tabIndex={105} />
                </div>
                <div className='editorParamsSetter'>
                  <label htmlFor='editorInkThickness' className='editorParamsLabel' data-l10n-id='pdfjs-editor-ink-thickness-input'>
                    Thickness
                  </label>
                  <input
                    type='range'
                ...
                <div className='editorParamsSetter'>
                  <label htmlFor='editorInkOpacity' className='editorParamsLabel' data-l10n-id='pdfjs-editor-ink-opacity-input'>
                    Opacity
                  </label>
                  <input
                    type='range'
                  ...
                  <div id='toolbarViewerMiddle'>
                    ...
                    <span id='scaleSelectContainer' className='dropdownToolbarButton'>
                      <select id='scaleSelect' title='Zoom' tabIndex={23} data-l10n-id='pdfjs-zoom-select'>
                        <option id='pageAutoOption' title='' value='auto' selected={true} data-l10n-id='pdfjs-page-scale-auto'>
                          Automatic Zoom
                        </option>
          ...
          <div id='dialogContainer'>
            ...
            <dialog id='printServiceDialog' style={{ minWidth: 200 }}>
              ...
              <div className='row'>
                ...
                <span data-l10n-id='pdfjs-print-progress-percent' data-l10n-args='{ "progress": 0 }' className='relative-progress'>
                  0%
                </span>
              </div>
              <div className='buttonRow'>
